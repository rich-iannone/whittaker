...
them, and explains when to use conformal intervals instead of (or alongside) the classical Bayesian
intervals from `predict()`.
...
- **[Prediction and inference](08-prediction.qmd)**: Bayesian confidence intervals, standard errors,
  and term-level decomposition.
- **[Diagnostics](11-diagnostics.qmd)**: residual plots and model checking to assess whether
  parametric intervals are trustworthy.
- **[Response families](05-families.qmd)**: all supported distributions and their link functions.
