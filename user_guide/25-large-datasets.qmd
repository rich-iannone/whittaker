...
- **[Streaming and online fitting](22-streaming.qmd)**: incremental fitting when data arrives in
  batches over time.
- **[Model fitting](06-fitting.qmd)**: how P-IRLS and smoothness selection work in the standard
  pipeline.
- **[Saving and loading models](38-serialization.qmd)**: persist a fitted large-data model for
  deployment.
