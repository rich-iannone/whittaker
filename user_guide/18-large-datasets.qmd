...
covariates and streaming aggregation to fit GAMs on large datasets without materialising the full
matrix:
...
).properties(width=500, height=300, title="BigGAM fit vs. truth (2,000 observations)")
```
