...
- **[Smooth terms](04-smooths.qmd)**: details on basis types, knot placement, and the `k` parameter.
- **[Model fitting](06-fitting.qmd)**: fitting methods and smoothing parameter selection.
- **[Data input](07-data-input.qmd)**: supported data formats and column types.
