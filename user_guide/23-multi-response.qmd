...
- **[Model diagnostics](11-diagnostics.qmd)**: check each response model's residuals and basis
  adequacy.
- **[Functional regression](24-functional.qmd)**: another multi-predictor setting where the
