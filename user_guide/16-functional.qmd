...
(points + ref_line).properties(width=300, height=300, title="Predicted vs. observed")
```
...
panel1 = (est1 + truth1).properties(width=300, height=250, title="f1: sin(2*pi*t)")
...
panel2 = (est2 + truth2).properties(width=300, height=250, title="f2: t^2 - t")
