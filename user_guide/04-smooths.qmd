...
both harmonics. Use `model.check()` (see [Diagnostics](11-diagnostics.qmd)) to decide if `k` is
large enough.
...
- **[Response families](05-families.qmd)**: choosing the right distribution and link function for
  your response variable.
- **[Model fitting](06-fitting.qmd)**: details on REML vs. GCV, the P-IRLS algorithm, and
  convergence diagnostics.
- **[Prediction and inference](08-prediction.qmd)**: standard errors, confidence intervals, and
  partial effect plots.
- **[Diagnostics](11-diagnostics.qmd)**: residual checks, `model.check()`, and concurvity.
