...
For one-shot large-dataset fitting, consider [BigGAM or PolarsGAM](25-large-datasets.qmd) instead.
:::
...
- **[Large datasets](25-large-datasets.qmd)**: BigGAM, PolarsGAM, and DuckDBGAM for one-shot
  fitting on large data.
- **[Model fitting](06-fitting.qmd)**: how P-IRLS and smoothness selection work under the hood.
- **[Saving and loading models](38-serialization.qmd)**: persist a fitted streaming model for later
  use.
