...
- **[Model comparison with LOO](28-loo.qmd)**: PSIS-LOO cross-validation for Bayesian model
  comparison without refitting.
- **[Model diagnostics](11-diagnostics.qmd)**: residual checks and basis adequacy tests as a
  complement to cross-validation.
- **[Model fitting](06-fitting.qmd)**: how smoothness selection (REML, GCV) relates to
  cross-validation.
