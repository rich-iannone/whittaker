...
The 2-D array stores one curve per row. See the [functional regression page](16-functional.qmd)
...
- **[Smooth terms](03-smooths.qmd)**: the smooth types available and how to configure them.
- **[Functional regression](16-functional.qmd)**: fitting models with functional covariates.
- **[Large datasets](18-large-datasets.qmd)**: scalable backends when the data does not fit in
  memory.
